...
def new_post(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(request, 'ایرادی در پر کردن فرم وجود داشت')
...
def edit_post(request, post_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('core/post_details', post_id=post.id)
        else:
            messages.error(request, 'اطلاعات فرم را دوباره بررسی کن')
